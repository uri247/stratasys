...
//
class __declspec(uuid("84c82989-7859-4243-a5fa-94e7364cbc83")) RenderFilterFactory : public UnknownBase<IClassFactory>
{
public:
    RenderFilterFactory() :
        m_serverLocks(0)
...
#pragma warning(suppress: 28204)
        ...
        )
    {
        ...
        *ppvObject = NULL;
        ...
        MS3DPrintDriver_Render_Filter::RenderFilter *pFilter = NULL;
...
#pragma warning(suppress: 28197)
			...
			pFilter = new MS3DPrintDriver_Render_Filter::RenderFilter();
        }
        CATCH_VARIOUS(hr)
    ...
    )
{
    ...
    *ppv = NULL;
    ...
    if (rclsid != __uuidof(MS3DPrintDriver_Render_Filter::RenderFilterFactory))
    {
    ...
    MS3DPrintDriver_Render_Filter::RenderFilterFactory *pFactory = NULL;

#pragma warning(suppress: 28197)
    pFactory = new(std::nothrow) MS3DPrintDriver_Render_Filter::RenderFilterFactory();
...
DllCanUnloadNow()
{
    return (0 == MS3DPrintDriver_Render_Filter::RenderFilter::ms_numObjects) ? S_OK : S_FALSE;
}
...
//        WPP_INIT_TRACING(L"MS3DPrintDriverRenderFilter");
